...
const TrendingProductsTable = () => {
  ...
  if (loading) {
    return <p className="text-center py-6 text-neutral-600">Loading trending products...</p>;
  }

  if (error && trendingProducts.length === 0) {
    return <p className="text-center py-6 text-red-500">Failed to load trending products.</p>;
  }
